...
function _update1to2(pipelineFlow) {
	...
	pipelineFlow.json_schema = "https://nielspardon.github.io/pipeline-schemas/common-pipeline/pipeline-flow/pipeline-flow-v2-schema.json";
...
function _update2to3(pipelineFlow) {
	...
	pipelineFlow.json_schema = "https://nielspardon.github.io/pipeline-schemas/common-pipeline/pipeline-flow/pipeline-flow-v3-schema.json";
